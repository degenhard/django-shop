...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_order', 'email', self.gf('django.db.models.fields.EmailField')(default='no@email.pl', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.email'
        db.delete_column('shop_order', 'email')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'default': "'no@email.pl'", 'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
